...
public class NegocioDTOA extends DTOA
{
	...
	public EmpresaDTOA getEmpresa () { return empresa; }
	public void setEmpresa (EmpresaDTOA empresa) { this.empresa = empresa; }
	...
	public void setFromJSON (JSONObject json)
	{
		try
		{
			...
			JSONObject jsonEmpresa = json.optJSONObject("Empresa");
			if (jsonEmpresa != null)
			{
				EmpresaDTOA tmp = new EmpresaDTOA();
				tmp.setFromJSON(jsonEmpresa);
				this.empresa = tmp;
			}
	...
	public JSONObject toJSON ()
	{
		...
		try
		{
		  ...
		  if (this.pais != null)
			...
			{
				json.put("Empresa", this.empresa.toJSON());
			}
	...
	dto.setPais (this.getPais());
		...
		// Roles
					// TODO: from DTOA [ Empresa ] (dataType : EmpresaDTOA) to DTO [ Empresa ]
