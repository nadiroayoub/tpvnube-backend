...
public TipoCobroEN(int id, System.Collections.Generic.IList<TPVNUBEGenNHibernate.EN.Rest.CobroEN> cobro, string descripcion
                   )
{
...
private void init (int id
                   , System.Collections.Generic.IList<TPVNUBEGenNHibernate.EN.Rest.CobroEN> cobro, string descripcion)
{
        this.Id = id;
