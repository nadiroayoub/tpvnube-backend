...
public UnidadMedidaEN(int id, string descripcion, System.Collections.Generic.IList<TPVNUBEGenNHibernate.EN.Rest.ProductoEN> producto
                      )
{
...
private void init (int id
                   , string descripcion, System.Collections.Generic.IList<TPVNUBEGenNHibernate.EN.Rest.ProductoEN> producto)
{
        this.Id = id;
