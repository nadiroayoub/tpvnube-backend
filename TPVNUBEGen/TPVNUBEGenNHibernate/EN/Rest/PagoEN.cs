 ...
 *	Atributo tipoPago
 */
private TPVNUBEGenNHibernate.EN.Rest.TipoPagoEN tipoPago;
...
public virtual TPVNUBEGenNHibernate.EN.Rest.TipoPagoEN TipoPago {
...
public PagoEN(int id, System.Collections.Generic.IList<int> idPedidoProveedor, double monto, System.Collections.Generic.IList<TPVNUBEGenNHibernate.EN.Rest.CompraProveedorEN> compraProveedor, Nullable<DateTime> fechaPago, TPVNUBEGenNHibernate.EN.Rest.TipoPagoEN tipoPago, int numeroDocumento, TPVNUBEGenNHibernate.EN.Rest.CajaEN caja
              )
{
...
private void init (int id
                   , System.Collections.Generic.IList<int> idPedidoProveedor, double monto, System.Collections.Generic.IList<TPVNUBEGenNHibernate.EN.Rest.CompraProveedorEN> compraProveedor, Nullable<DateTime> fechaPago, TPVNUBEGenNHibernate.EN.Rest.TipoPagoEN tipoPago, int numeroDocumento, TPVNUBEGenNHibernate.EN.Rest.CajaEN caja)
{
        this.Id = id;
