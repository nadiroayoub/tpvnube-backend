...
public FacturaEN(int id, string numero, Nullable<DateTime> fecha, double precio, string descripcion, TPVNUBEGenNHibernate.EN.Rest.ComandaEN comanda, TPVNUBEGenNHibernate.EN.Rest.ClienteEN cliente
                 )
{
...
private void init (int id
                   , string numero, Nullable<DateTime> fecha, double precio, string descripcion, TPVNUBEGenNHibernate.EN.Rest.ComandaEN comanda, TPVNUBEGenNHibernate.EN.Rest.ClienteEN cliente)
{
        this.Id = id;
