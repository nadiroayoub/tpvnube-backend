...
public int NuevaLineaServicio (int p_cantidad, int p_servicio, int p_compraProveedor, int p_producto, double p_Costo)
{
        ...
        if (p_servicio != -1) {
                ...
                // Lista de oids id
                lineaCompraProveedorEN.Servicio = new TPVNUBEGenNHibernate.EN.Rest.ServicioEN ();
        ...
        if (p_compraProveedor != -1) {
                ...
                // Lista de oids id
                lineaCompraProveedorEN.CompraProveedor = new TPVNUBEGenNHibernate.EN.Rest.CompraProveedorEN ();
        ...
        if (p_producto != -1) {
                ...
                // Lista de oids id
                lineaCompraProveedorEN.Producto = new TPVNUBEGenNHibernate.EN.Rest.ProductoEN ();
