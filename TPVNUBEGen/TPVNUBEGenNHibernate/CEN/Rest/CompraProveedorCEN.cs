...
public int Nuevo (System.Collections.Generic.IList<TPVNUBEGenNHibernate.EN.Rest.LineaCompraProveedorEN> p_lineaCompraProveedor, int p_proveedor, int p_negocio, TPVNUBEGenNHibernate.Enumerated.Rest.EstadoCompraProveedorEnum p_estadoCompra, Nullable<DateTime> p_fecha)
{
        ...
        if (p_proveedor != -1) {
                ...
                // Lista de oids id
                compraProveedorEN.Proveedor = new TPVNUBEGenNHibernate.EN.Rest.ProveedorEN ();
        ...
        if (p_negocio != -1) {
                ...
                // Lista de oids id
                compraProveedorEN.Negocio = new TPVNUBEGenNHibernate.EN.Rest.NegocioEN ();
...
public void Modificar (int p_CompraProveedor_OID, TPVNUBEGenNHibernate.Enumerated.Rest.EstadoCompraProveedorEnum p_estadoCompra, Nullable<DateTime> p_fecha)
{
        CompraProveedorEN compraProveedorEN = null;
