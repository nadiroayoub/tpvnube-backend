                                 ...
                                 )
{
        ...
        try
        {
                ...
                if (ex is TPVNUBEGenNHibernate.Exceptions.ModelException)
                        throw ex;
                throw new TPVNUBEGenNHibernate.Exceptions.DataLayerException ("Error in NegocioCAD.", ex);
        }
...
public int Nuevo (NegocioEN negocio)
{
        try
        {
                ...
                if (negocio.Empresa != null) {
                        ...
                        negocio.Empresa = (TPVNUBEGenNHibernate.EN.Rest.EmpresaEN)session.Load (typeof(TPVNUBEGenNHibernate.EN.Rest.EmpresaEN), negocio.Empresa.Id);
