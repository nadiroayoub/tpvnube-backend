                                 ...
                                 )
{
        ...
        try
        {
                ...
                if (ex is TPVNUBEGenNHibernate.Exceptions.ModelException)
                        throw ex;
                throw new TPVNUBEGenNHibernate.Exceptions.DataLayerException ("Error in FacturaCAD.", ex);
        }
...
public int Nuevo (FacturaEN factura)
{
        try
        {
                ...
                if (factura.Comanda != null) {
                        ...
                        factura.Comanda = (TPVNUBEGenNHibernate.EN.Rest.ComandaEN)session.Load (typeof(TPVNUBEGenNHibernate.EN.Rest.ComandaEN), factura.Comanda.Id);
                ...
                if (factura.Cliente != null) {
                        // Argumento OID y no colección.
                        factura.Cliente = (TPVNUBEGenNHibernate.EN.Rest.ClienteEN)session.Load (typeof(TPVNUBEGenNHibernate.EN.Rest.ClienteEN), factura.Cliente.Id);
