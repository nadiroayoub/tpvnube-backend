                                  ...
                                  )
{
        ...
        try
        {
                ...
                if (ex is TPVNUBEGenNHibernate.Exceptions.ModelException)
                        throw ex;
                throw new TPVNUBEGenNHibernate.Exceptions.DataLayerException ("Error in ProductoCAD.", ex);
        }
...
public int Nuevo (ProductoEN producto)
{
        try
        {
                ...
                if (producto.UnidadMedida != null) {
                        ...
                        producto.UnidadMedida = (TPVNUBEGenNHibernate.EN.Rest.UnidadMedidaEN)session.Load (typeof(TPVNUBEGenNHibernate.EN.Rest.UnidadMedidaEN), producto.UnidadMedida.Id);
                ...
                if (producto.Negocio != null) {
                        // Argumento OID y no colección.
                        producto.Negocio = (TPVNUBEGenNHibernate.EN.Rest.NegocioEN)session.Load (typeof(TPVNUBEGenNHibernate.EN.Rest.NegocioEN), producto.Negocio.Id);
