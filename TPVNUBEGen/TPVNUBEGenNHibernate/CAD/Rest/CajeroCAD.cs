                                ...
                                )
{
        ...
        try
        {
                ...
                if (ex is TPVNUBEGenNHibernate.Exceptions.ModelException)
                        throw ex;
                throw new TPVNUBEGenNHibernate.Exceptions.DataLayerException ("Error in CajeroCAD.", ex);
        }
        ...
        try
        {
                ...
                if (cajero.Caja != null) {
                        for (int i = 0; i < cajero.Caja.Count; i++) {
                                cajero.Caja [i] = (TPVNUBEGenNHibernate.EN.Rest.CajaEN)session.Load (typeof(TPVNUBEGenNHibernate.EN.Rest.CajaEN), cajero.Caja [i].Id);
