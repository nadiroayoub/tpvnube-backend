		...
		public class NegocioDTO 	    implements IDTO
	    {
				...
				private ArrayList<Integer> menu_oid;
				public ArrayList<Integer>  getMenu_oid () { return menu_oid; } 
				public void setMenu_oid (ArrayList<Integer> value) { menu_oid = value;  } 
			    ...
			    public JSONObject toJSON ()
				{
					...
					try
					{
						...
						{
							JSONArray jsonArray = new JSONArray();
							for (int i = 0; i < this.menu_oid.size(); ++i)
							{
								jsonArray.put(this.menu_oid.get(i));
							}
							json.put("Menu_oid", jsonArray);
						}
