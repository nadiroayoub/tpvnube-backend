...
public DuenyoEN Duenyo (int id)
{
        ...
        try
        {
                ...
                String sql = @"select self.Duenyo FROM CajaEN self " +
                             "where self.Id = :p_Id";
...
public IList<CobroEN> GetAllCobroOfCaja (int id)
{
...
public NegocioEN NegocioCaja (int id)
{
        ...
        try
        {
                ...
                String sql = @"select self.Negocio FROM CajaEN self " +
                             "where self.Id = :p_Id";
                IQuery query = session.CreateQuery (sql).SetParameter ("p_Id", id);
